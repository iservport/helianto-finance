...
public interface AbstractFinanceRepository extends JpaRepository<AbstractFinance, Serializable> {
	 ...
	 * @param end
	 */
	List<AbstractFinance> findByEntity_IdAndResolutionInAndPaymentDateBetween(Integer privateEntityId, Set<Character> resolutions, Date start, Date end);
	 ...
	 * @param end
	 */
	List<AbstractFinance> findByEntity_IdAndResolutionInAndNextCheckDateAfter(Integer entityId, Set<Character> resolutions, Date start);
	 ...
	 * @param end
	 */
	List<AbstractFinance> findByEntity_IdAndResolutionInAndPaymentDateAfter(Integer entityId, Set<Character> resolutions, Date start);
	 ...
	 * @param end
	 */
	List<AbstractFinance> findByPrivateEntity_IdAndResolutionInAndPaymentDateBetween(Integer privateEntityId, Set<Character> resolutions, Date start, Date end);
	 ...
	 * @param end
	 */
	List<AbstractFinance> findByPrivateEntity_IdAndResolutionInAndNextCheckDateAfter(Integer privateEntityId, Set<Character> resolutions, Date start);
